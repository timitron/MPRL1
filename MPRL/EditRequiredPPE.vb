...
Public Class FormEditRequiredPPE
    ...
    Private Sub BtnRemove_Click(sender As Object, e As EventArgs) Handles BtnRemove.Click
        ...
        query = "DELETE FROM [MachineTool-PPELink] WHERE(MachineToolID = '" & GlobalVariables.Click & "') AND (PPEID = '" & CmboboxRemove.SelectedItem & "') AND (Required = 1)"
    ...
    Private Sub BtnAdd_Click(sender As Object, e As EventArgs) Handles BtnAdd.Click
        ...
        Dim query As String
        Dim Table_ As String = "RequiredSelected"
        query = "INSERT INTO [MachineTool-PPELink] (MachineToolID, PPEID, Required, Hidden) VALUES('" & GlobalVariables.Click & "', '" & CmboboxAdd.SelectedItem & "', 1, 0)"
        Dim cmd As New OleDbCommand(query, cnn)
        Dim response As Integer

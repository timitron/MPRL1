...
Public Class FormEditMachiningMethodMachineToolLink
    ...
    Private Sub BtnRemove_Click(sender As Object, e As EventArgs) Handles BtnRemove.Click
        ...
        Dim query As String = "DELETE FROM `MachineTool-MachiningMethodsLink` WHERE ((`MachineToolID` = '" & GlobalVariables.Click & "') AND (`MachiningMethodID` = '" & CmboboxRemove.SelectedItem & "'))"
    ...
    Private Sub BtnAdd_Click(sender As Object, e As EventArgs) Handles BtnAdd.Click
        ...
        Dim query As String = "INSERT INTO `MachineTool-MachiningMethodsLink` (`MachineToolID`, `MachiningMethodID`) VALUES ('" & GlobalVariables.Click & "','" & CmboboxAdd.SelectedItem & "')"
    ...
    Sub update_linkedmethods_combobox()
        ...
        Dim query As String = "SELECT MachiningMethods.Name, MachiningMethods.ImageURL FROM ((MachiningMethods INNER JOIN [MachineTool-MachiningMethodsLink] ON MachiningMethods.Name = [MachineTool-MachiningMethodsLink].MachiningMethodID) INNER JOIN                         MachineTools ON [MachineTool-MachiningMethodsLink].MachineToolID = MachineTools.Name) WHERE        (MachineTools.Name = '" & TargetID & "');" 'data connection querry this must be run through the oledb command interpreter before executing it on the connection
    ...
    Sub update_allMachiningMethods_combobox()
        ...
        Dim query As String = "SELECT        Name FROM            MachiningMethods"
